...
function Markets(props) {
    ...
    return (
      <div className="container my-4">
        <h2 className="h2" style={{textAlign:'center'}}>Trade Market</h2>
          {
                ...
                topheadlines.articles.map((data)=>{
                  return (
                    ...
                    <div key={data.publishedAt} className="col-md-3 my-2">
                      <MarketsComponents image = {data.urlToImage} heading={data.title} desc={data.description} url={data.url} time={data.publishedAt}/>
                    </div>
                  )
                })
              }
